...
/**
 * ParameterID is used to identify a Parameter within a (Sub)Select. This can be either a parameter of a Prepared SELECT
 * statement `SELECT * FROM t WHERE a > ?` or a correlated parameter in a Subselect.
 */
